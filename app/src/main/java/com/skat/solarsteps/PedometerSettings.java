...
public class PedometerSettings {
    ...
    public float getSleep() {
        try {
            return Float.valueOf(mSettings.getString("sleep", "8").trim());
        }
        catch (NumberFormatException e) {
            return 0f;
        }
    ...
    public boolean isWalking() {
        return mSettings.getString("exercise_type", "walking").equals("running");
    }
    ...
    public void saveServiceRunningWithTimestamp(boolean running) {
        ...
        editor.putLong("last_seen", com.skat.solarsteps.Utils.currentTimeInMillis());
        editor.commit();
    }
    ...
    public boolean isNewStart() {
        return mSettings.getLong("last_seen", 0) < com.skat.solarsteps.Utils.currentTimeInMillis() - 1000*60*10;
    }
