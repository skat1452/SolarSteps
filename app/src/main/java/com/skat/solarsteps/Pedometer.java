...
import com.skat.solarsteps.constant.Constants;
import com.skat.solarsteps.interfaceapi.WeatherApi;
import com.skat.solarsteps.model.Main;
import com.skat.solarsteps.model.Weather;
...
public class Pedometer extends Activity {
    private static final String TAG = "Solar Steps";
    private SharedPreferences mSettings;
    private com.skat.solarsteps.PedometerSettings mPedometerSettings;
    ...
    protected void onResume() {
        ...
        mPedometerSettings = new com.skat.solarsteps.PedometerSettings(mSettings);
        ...
        ((LinearLayout) this.findViewById(R.id.desired_pace_control)).setVisibility(
                mMaintain != com.skat.solarsteps.PedometerSettings.M_NONE
                        ? View.VISIBLE
                        : View.GONE
        );
        if (mMaintain == com.skat.solarsteps.PedometerSettings.M_PACE) {
            mMaintainInc = 5f;
            mDesiredPaceOrSpeed = (float) mPedometerSettings.getDesiredPace();
        } else if (mMaintain == com.skat.solarsteps.PedometerSettings.M_SPEED) {
        ...
        if (mMaintain != com.skat.solarsteps.PedometerSettings.M_NONE) {
            ((TextView) findViewById(R.id.desired_pace_label)).setText(
                    mMaintain == com.skat.solarsteps.PedometerSettings.M_PACE
    ...
    private com.skat.solarsteps.StepService mService;

    private ServiceConnection mConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder service) {
            mService = ((com.skat.solarsteps.StepService.StepBinder) service).getService();
    ...
    private void startStepService() {
        if (!mIsRunning) {
            ...
            startService(new Intent(Pedometer.this,
                    com.skat.solarsteps.StepService.class));
        }
    }
    ...
    private void bindStepService() {
        ...
        bindService(new Intent(Pedometer.this,
                com.skat.solarsteps.StepService.class), mConnection, Context.BIND_AUTO_CREATE + Context.BIND_DEBUG_UNBIND);
    }
    ...
    private com.skat.solarsteps.StepService.ICallback mCallback = new com.skat.solarsteps.StepService.ICallback() {
    ...
    private java.util.List<com.skat.solarsteps.model.List> responseList;
    ...
    public void getData() {
        ...
        weatherCollectionResponseCall.enqueue(new Callback<WeatherCollectionResponse>() {
            ...
            public void onFailure(Call<WeatherCollectionResponse> call, Throwable t) {
                Toast.makeText(Pedometer.this, " Ошибка соединения", Toast.LENGTH_SHORT).show();
    ...
    public void initializeNetworkingLibrary() {
